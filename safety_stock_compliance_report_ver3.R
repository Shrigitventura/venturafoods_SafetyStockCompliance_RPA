...
specific_date <- as.Date("2025-02-18")

#create the folder for new date
mainDir <- "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025"
subDir <- "02.18.2025"
dir.create(file.path(mainDir, subDir))
setwd(file.path(mainDir, subDir))

# (Path revision needed) load main board (mega data) ----
load("C:/Users/SPoudel/OneDrive - Ventura Foods/Desktop/VenturaCodesRStudio/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_02_11_2025.rds") # Load pre week
...
inventory_model <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/SS Optimization by Location - Finished Goods LIVE.xlsx",
...
ssmetrics_pre <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Static_MonthlyLookup Dataset/Copy of Safety Stock Compliance Report Data v3 - 06.05.23.xlsx",  ### No Impact ###
                            col_names = FALSE)
...
custord <- read.xlsx("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/US and CAN OO BT where status _ J.xlsx",
                     colNames = FALSE)
...
custord %>% 
  janitor::clean_names() %>% 
  dplyr::mutate(product_label_sku = gsub("-", "", product_label_sku_code)) %>% 
  ...
  dplyr::select(ref, product_label_sku, location_no, Qty, sales_order_requested_ship_date) %>% 
...
wo <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/Open Work Order for 28 days.xlsx")
...
receipt <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/BT open order and qty.xlsx")
...
po <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/PO_JDE.xlsx",
                 sheet = "Daily Open PO")
...
JDOH_complete <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/Inventory with Lot Report v.2.xlsx",
                            sheet = "FG")
...
################### RM ####################
JDOH_complete_2 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/Inventory with Lot Report v.2.xlsx",
                              sheet = "RM")
...
JDOH_complete_2_2 %>% 
  ...
  dplyr::mutate(Balance_Usable = useable + soft_hold,
                Balance_Hold = hard_hold,
                On_Hand = Balance_Usable + Balance_Hold) %>% 
  dplyr::select(-useable, -hard_hold, -soft_hold,-na) -> JDOH_complete_2_2
...
write_xlsx(JDOH_complete, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025/02.18.2025/JDOHTest.xlsx") 
####################################################################################################################################################
############################################################### 6/5/2023 Update ####################################################################
####################################################################################################################################################
####################################################################################################################################################
...
# Add Location 430
loc_430_for_jdoh <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/430.xlsx")
...
jde_inv_for_25_55_label <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Lookup Datasets/Current Week Dataset/JDE Inventory Lot Detail.xlsx")
...
jde_inv_for_25_55_label %>% 
  ...
  #dplyr::select(ref, b_p, item, description, useable, hard_hold, on_hand) -> jde_inv_for_25_55_label
...
pre_ss_metrics <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025/02.11.2025/SS Metrics 0211.xlsx")
...
iqr_fg <- readxl::read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/FG/Weekly Run Files/2025/02.11.2025/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 02.11.2025.xlsx",
                             sheet = "Location FG")
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025/02.18.2025/SS Metrics 0218.xlsx") 
...
file.copy("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025/02.11.2025/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 02.11.2025.xlsb",
          "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/Safety Stock Compliance/Weekly Run Files/2025/02.18.2025/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 02.18.2025.xlsb")
